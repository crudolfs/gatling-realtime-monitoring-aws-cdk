...
public interface GatlingFargateServiceProps {
    ...
    String monitoringServiceDiscoveryEndpoint();
    ...
    class Builder {
        ...
        private String monitoringServiceDiscoveryEndpoint;
        ...
        public Builder monitoringServiceDiscoveryEndpoint(String endpoint) {
            this.monitoringServiceDiscoveryEndpoint = endpoint;
            return this;
        }
        ...
        GatlingFargateServiceProps build() {
            return new GatlingFargateServiceProps() {
                ...
                @Override
                public String monitoringServiceDiscoveryEndpoint() {
                    return monitoringServiceDiscoveryEndpoint;
                }
